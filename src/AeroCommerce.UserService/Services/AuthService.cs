...
using AeroCommerce.UserService.Domain.Exceptions;
using Microsoft.EntityFrameworkCore;
using Microsoft.IdentityModel.Tokens;

namespace AeroCommerce.UserService.Services;
...
public class AuthService : IAuthService
{
    ...
    public async Task<AuthResponse> RegisterAsync(RegisterRequest request)
    {
        ...
        var sp = new AeroCommerce.UserService.Data.StoredProcedures.UserStoredProcedures(_db);
        ...
        var subject = "Mã xác nhận đăng ký tài khoản (OTP) - AeroCommerce";
    ...
    public async Task<bool> ForgotPasswordAsync(ForgotPasswordRequest request)
    {
        ...
        {
            var subject = "Yêu cầu khôi phục mật khẩu - AeroCommerce";
    ...
    private async Task SendEmailAsync(string toEmail, string subject, string body)
    {
        try
        {
            ...
            {
                From = new MailAddress(username!, "AeroCommerce Auth"),
                Subject = subject,
                Body = body,
                IsBodyHtml = true
            };
