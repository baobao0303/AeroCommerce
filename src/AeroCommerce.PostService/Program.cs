using System.Text;
using AeroCommerce.PostService.Data;
using AeroCommerce.PostService.Data.StoredProcedures;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "AeroCommerce PostService", Version = "v1" });
