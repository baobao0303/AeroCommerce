using AeroCommerce.OrderService.Data;
...
builder.Services.AddSwaggerGen(c => {
    c.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo { Title = "AeroCommerce Order Service API", Version = "v1" });
});
...
using (var scope = app.Services.CreateScope())
{
    ...
    {
        logger.LogWarning("[OrderService] Could not connect to database on startup: {Message}", ex.Message);
    }
}
